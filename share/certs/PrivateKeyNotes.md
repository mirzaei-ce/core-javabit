...
unlocked to sign the Javabit-Qt.app bundle.
...
allowing somebody to distribute a Javabit-Qt.app or javabit-qt-setup.exe with a valid
...
that the javabit-qt.exe file inside the installer had not been tampered with.
