...
#ifndef JAVABIT_TEST_SCRIPTNUM10_H
#define JAVABIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Javabit Core 0.10.0, for cross-comparison.
 */
public:
