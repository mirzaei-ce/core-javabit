...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CJavabitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CJavabitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CJavabitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CJavabitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CJavabitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CJavabitAddress(arr[0].get_str()).Get() == demoAddress.Get());
