...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/javabit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Javabit Core"),
     ...
     * override -datadir in the javabit.conf file in the default data directory
     * (to be consistent with javabitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
