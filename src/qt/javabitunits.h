...
#ifndef JAVABIT_QT_JAVABITUNITS_H
#define JAVABIT_QT_JAVABITUNITS_H
...
/** Javabit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class JavabitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit JavabitUnits(QObject *parent);

    /** Javabit units.
      @note Source: https://en.javabit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        JBT,
...
typedef JavabitUnits::Unit JavabitUnit;

#endif // JAVABIT_QT_JAVABITUNITS_H
