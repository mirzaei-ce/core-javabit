...
#if defined(NDEBUG)
# error "Javabit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Javabit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s JBT additional fees, %d delta bytes\n",
