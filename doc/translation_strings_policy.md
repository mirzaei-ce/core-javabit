...
This document provides guidelines for internationalization of the Javabit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `javabit_en.ts` remains unchanged.
