Download URL: https://sourceforge.net/projects/javabit/files/Javabit/javabit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 JBT fee schedule (users still pay 0.01 JBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #javabit00 - #javabit99
