Javabit Core version 0.9.2.1 is now available from:

  https://javabit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 JBT to 0.01 JBT
...
- Fix "Start javabit on system login"
