Javabit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/javabit/files/Javabit/javabit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Javabit
...
New/changed settings (command-line or javabit.conf file)
--------------------------------------------------------
