Javabit Core version 0.9.4 is now available from:

  https://javabit.org/bin/0.9.4/
...
this update is incompatible with the Javabit system and could lead to consensus
forks.

Javabit Core released binaries from https://javabit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~javabit/+archive/ubuntu/javabit
- A third-party or self-compiled Javabit Core

upgrade to Javabit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
