Javabit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/javabit/files/Javabit/javabit-0.5.4/
...
http://gitorious.org/javabit/javabitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Javabit-Qt notifications under Growl 1.3.
Increase required age of Javabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxJavabit properly when installing Javabit-Qt over it. (Windows)
